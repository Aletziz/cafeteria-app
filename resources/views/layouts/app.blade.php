...
<head>
    ...
    <title>@yield('title', 'Cafetería El Aroma')</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top">
        <div class="container">
            ...
            <div class="d-flex align-items-center">
                <!-- Mobile Cart Icon -->
                <a class="nav-link position-relative me-3 d-lg-none" href="{{ route('cart.index') }}">
    ...
    <footer class="footer py-4">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{ route('menu') }}" class="text-light">Menú</a></li>
                        <li><a href="{{ route('about') }}" class="text-light">Nosotros</a></li>
            ...
            <div class="text-center">
                <p>&copy; {{ date('Y') }} Cafetería El Aroma. Todos los derechos reservados.</p>
            </div>
        </div>
    </footer>
