<?php $__env->startSection('title', 'Menú - Cafetería El Aroma'); ?>
        ...
        <div class="row align-items-center min-vh-40">
            <div class="col-lg-8 mx-auto text-center">
                ...
                <div class="d-flex justify-content-center gap-3">
                    ...
                    <a href="<?php echo e(route('cart.index')); ?>" class="btn btn-outline-light btn-lg">
...
<section class="py-5" id="productos">
    <div class="container">
                ...
                <div class="d-flex flex-wrap justify-content-center gap-3">
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button class="btn btn-outline-primary category-filter" data-category="<?php echo e($category->id); ?>">
                            <i class="fas fa-coffee me-2"></i><?php echo e($category->name); ?>
        ...
        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="category-section mb-5" data-category-id="<?php echo e($category->id); ?>">
                <div class="row mb-4">
                    <div class="col-12">
                ...
                <div class="row g-4">
                    <?php $__empty_1 = true; $__currentLoopData = $category->products->where('available', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="col-md-6 col-lg-4 product-card" data-category="<?php echo e($category->id); ?>">
                            <div class="card h-100">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <p class="card-text text-muted flex-grow-1"><?php echo e($product->description); ?></p>
                                    
                                    <div class="mt-auto">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <span class="h4 text-primary mb-0"><?php echo e($product->formatted_price); ?></span>
                                            <small class="text-muted">
                                                <i class="fas fa-box me-1"></i>Stock: <?php echo e($product->stock); ?>
                                            ...
                                            <form action="<?php echo e(route('cart.add', $product->id)); ?>" method="POST" class="add-to-cart-form">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="number" class="form-control text-center quantity-input" 
                                                           name="quantity" value="1" min="1" max="<?php echo e($product->stock); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Alexis\OneDrive\Desktop\laravel\cafeteria-app\resources\views/menu.blade.php ENDPATH**/ ?>