<?php $__env->startSection('title', 'Checkout - Cafetería El Aroma'); ?>
            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('cart.index')); ?>">Carrito</a></li>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="notes" name="notes" rows="3" 
                                              placeholder="Instrucciones especiales para tu pedido..."><?php echo e(old('notes')); ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card sticky-top checkout-summary" style="top: 20px;">
                            ...
                            <div class="card-body">
                                    ...
                                    <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <div class="flex-grow-1">
                                                <small class="fw-bold"><?php echo e($item['product']->name); ?></small>
                                                <br>
                                                <small class="text-muted"><?php echo e($item['quantity']); ?> x $<?php echo e(number_format($item['product']->price, 2)); ?></small>
                                            </div>
                                            <small class="fw-bold">$<?php echo e(number_format($item['subtotal'], 2)); ?></small>
                                        </div>
                                ...
                                <div class="d-flex justify-content-between mb-3">
                                    <strong>Total:</strong>
                                    <strong class="text-primary h5">$<?php echo e(number_format($total, 2)); ?></strong>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Alexis\OneDrive\Desktop\laravel\cafeteria-app\resources\views/checkout.blade.php ENDPATH**/ ?>