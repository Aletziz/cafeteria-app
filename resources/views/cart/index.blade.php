...
@section('title', 'Carrito de Compras - Cafetería El Aroma')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-0">
                            @foreach($cartItems as $item)
                                <div class="cart-item border-bottom p-4" data-id="{{ $item['product']->id }}">
                                    <div class="row align-items-center">
                                        <div class="col-md-2 col-sm-3 col-4">
                                            <img src="{{ $item['product']->image ?: 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?ixlib=rb-4.0.3' }}" 
                                                 class="cart-item-image img-fluid rounded" alt="{{ $item['product']->name }}">
                                        </div>
                                        <div class="col-md-4 col-sm-9 col-8 cart-item-details">
                                            <h6 class="cart-item-title">{{ $item['product']->name }}</h6>
                                            <small class="cart-item-price">Precio unitario: ${{ number_format($item['product']->price, 2) }}</small>
                                        </div>
                                        ...
                                        <div class="col-md-2 col-sm-4 col-8">
                                            <strong class="cart-item-total">${{ number_format($item['subtotal'], 2) }}</strong>
                                        </div>
                                        <div class="col-md-1 col-sm-2 col-4">
                                            <button class="btn btn-outline-danger btn-sm" 
                                                    onclick="removeFromCart({{ $item['product']->id }})" title="Eliminar">
                    ...
                    <div class="card order-summary cart-summary sticky-top" style="top: 20px;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between mb-4">
                                ...
                                <strong class="text-primary h4 mb-0" id="total">${{ number_format($total, 2) }}</strong>
                            </div>
                            
                            <div class="d-grid gap-3">
                                <a href="{{ route('checkout') }}" class="btn btn-primary btn-lg shadow-sm">
